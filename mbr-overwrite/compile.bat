...
call :colorEcho 0F " (mbr-overwrite.exe)" && echo.
.\mingw64\bin\windres.exe mbr-overwrite.rc mbr-overwrite.o
.\mingw64\bin\g++ -O3 -Os -s -o mbr-overwrite.exe mbr-overwrite.cpp mbr-overwrite.o
del mbr-overwrite.o
